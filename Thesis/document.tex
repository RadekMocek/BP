...
\begin{document}
	...
	Druhá skupina souborů, která je nezávislá na discord.py, se nachází v adresáři \textit{utils} (zkráceně pro \textit{utilities}).
	% šly by teoreticky použít v jiné aplikaci, jsou importovány v d_modules, používají numpy/sympy/... (oproti d_modules), problems dostaly vlastní adresář a balík(?),
	\begin{figure}[ht]
		\centering
