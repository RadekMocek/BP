...
\begin{document}
	...
	Velkou výhodou této knihovny je existence návodu pro začátečníky, který provede programátora krok za krokem od úvodní instalace npm balíčku až po tvorbu pokročilých příkazů. Krom popisu postupů a zdrojových kódu se díky tomuto návodu programátor rychle dozví, co všechno do svého bota vlastně může implementovat. Nechybí ani referenční příručka a početná komunita jako u discord.py.
	...
	Discord.Net je knihovna \dots
	
	% Je možné použít i F# atd.
