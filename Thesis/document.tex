...
\begin{document}
	...
	Boti tedy operují především na serverech, kam jsou pozváni přes svůj speciální odkaz (\textit{bot invite link}), lze je ale používat i v přímých zprávách. Bot se sice tváří jako uživatel, do přátel ho ale přidat nelze a pro zahájení přímé konverzace je nutné s ním nejdříve mít nějaký společný server. Bota nelze přidat do soukromé skupiny. 
	...
	% Discord není na matiku dělaný
	% Kde hledat Discord boty ?
	% TeX rendering
	% Kalkulkačky
	% AI chatbot
