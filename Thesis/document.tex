...
Funkce __approx_tex_frac_replace(čitatel, jmenovatel: str) vrací str:
	...
	V rámci této bakalářské práce byl vytvořen matematický bot pro sociální platformu Discord zvaný LingeBot. Ten byl implementován v jazyce Python za pomoci knihovny discord.py. Jeho třemi hlavními funkcemi jsou vykreslování matematických výrazů, výklad teorie a generování příkladů z lineární algebry. Veškeré funkce bota probíhají v prostředí textového chatu a lze je spouštět pomocí tzv. podpůrných příkazů, které začínají lomítkem.
	...
	\end{itemize}
	{\let\clearpage\relax \chapter{Zdrojové kódy implementace ukázkového příkazu}\label{AppendixCodeExamples}}
	\begin{figure}[ht]
		\centering
