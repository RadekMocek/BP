...
\begin{document}
	...
	JDA je knihovna pro tvorbu botů v jazyce Java nebo Kotlin. Do projektu je přidána pomocí nástroje Maven nebo Gradle. Stejně jako u Discord.Net je bot v JDA tvořen objektově. % separace slashCommand sync/handle
