...
\begin{document}
	...
	\chapter{Matematika na platformě Discord} %todo Zde na začátek přidat, proč byl zvolen discord
	...
	Discord API, se kterým program ovládající bota komunikuje, se dělí na dvě hlavní vrstvy: Pro obecné operace slouží HTTPS REST API a pro odesílání a přihlašování k událostem v reálném čase se používají trvalá zabezpečená připojení pomocí protokolu WebSocket \cite{doc_Discord}. Samotná komunikace pak probíhá ve formátu JSON a pro unikátní identifikátory všech objektů se využívá formát Twitter Snowflake ID.
	
	Většina operací v Discord API je případně konzistentní. To znamená, že \dots \cite{book_distributedSystems4}
	...
	\begin{table}[ht]
		...
		\begin{threeparttable}
			\begin{tabular}{ l l r }
				\textbf{Název} & \textbf{Jazyk} & \textbf{Popularita}\tnote{*} \\\hline
				discord.js & JavaScript & 24 452 \\
				discord.py & Python & 14 024 \\
				DiscordGo & Go & 4 563 \\
				serenity & Rust & 4 259 \\
				JDA & Java & 4 038 \\
				Discord.Net & C\# & 3 165 \\\hline
			\end{tabular}
			\begin{tablenotes}
