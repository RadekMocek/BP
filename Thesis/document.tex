...
\begin{document}
	...
	% Tlačítka ...	
	% Zmínit původně zamýšlený upload vlastních témat, nakonec self-host řešení	
	% výklad teorie, self host ready
			
	% generace příkladů (kalkulačka netřeba)
	% specifické discord možnosti (administrace, interactions)
