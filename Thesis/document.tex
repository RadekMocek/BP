...
Funkce __approx_tex_frac_replace(čitatel, jmenovatel: str) vrací str:
	...
	V rámci této bakalářské práce byla provedena rešerše sociálních platforem, které oficiálně podporují integraci botů. Následně byla zanalyzována skupina existujících Discord botů, kteří se alespoň částečně zabývají tématem matematiky. Poslední část rešerše se zabývá knihovnami, které usnadňují tvorbu botů pro platformu Discord.
